...
class DatabaseManager:
    """
    Manages dual database connections:
    - SQLite (WAL mode) for OLTP transactional queries (user lookups, inserts)
    - DuckDB (in-memory) for OLAP analytical queries (aggregations over Parquet)
    """
    def __init__(self):
